...
*/
  ...
  CompilerCOM.loadComponents(this);
};
...
Project.prototype.compile = function() {
  ...
  this._htmlFiles.forEach(
    function(filename) {
      try {
        this._htmDir = Path.dirname(this.srcPath(filename));
...
Project.prototype.findHtmlFiles = function() {
  ...
  console.log("Looking for files matching this pattern: ".cyan + JSON.stringify(filters));
