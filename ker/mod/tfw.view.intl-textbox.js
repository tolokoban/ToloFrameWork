...
function onValueChanged( newValue ) {
  console.info("[tfw.view.intl-textbox::onValueChanged] newValue=", newValue);
  ...
  console.info("[tfw.view.intl-textbox] this.language=", this.language);
  console.info("[tfw.view.intl-textbox] this.value=", this.value);
}
